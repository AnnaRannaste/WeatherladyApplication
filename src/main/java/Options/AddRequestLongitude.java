...
public class AddRequestLongitude {
    public static void addLocation(String typeLongitude) throws Exception {
        ...
        String response1 = String.valueOf(HTTPConnection1.getWeatherRequest(typeLongitude)); //HHTPConnection 1
        ...
        String response2 = String.valueOf(HTTPConnection2.getWeatherRequest(typeLongitude)); //HTTPConnection 2
